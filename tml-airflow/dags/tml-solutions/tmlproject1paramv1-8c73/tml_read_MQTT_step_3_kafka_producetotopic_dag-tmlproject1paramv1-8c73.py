...
default_args = {
  ...
  'mqtt_broker' : '7f10a97b196d4aa1bdb82175c68313e9.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_tmlproject1paramv1-8c73", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_tmlproject1paramv1-8c73"], schedule=None,catchup=False)
